Backdrop.behaviors.wordpressMigrate = Backdrop.behaviors.wordpressMigrate || {};

Backdrop.behaviors.wordpressMigrate.attach = function (context, settings) {
  var $ = jQuery;
  // "Map content" section
  $('fieldset#edit-wordpress-migrate-content-mapping', context).backdropSetSummary(function (context) {
  ...
  $('fieldset#edit-wordpress-migrate-text-formats', context).backdropSetSummary(function (context) {
  ...
  $('fieldset#edit-wordpress-migrate-taxonomy', context).backdropSetSummary(function (context) {
  ...
  $('fieldset#edit-wordpress-migrate-path-aliases', context).backdropSetSummary(function (context) {
